...
struct Devote_WidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = Devote_WidgetAttributes(name: "Me")
    static let contentState = Devote_WidgetAttributes.ContentState(value: 3)
